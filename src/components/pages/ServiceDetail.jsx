...
function ServiceDetail() {
  ...
  const routePath = lang === 'es'
    ? `/es/servicio/${languageSlugMap[serviceKey].es}`
    : `/en/service/${languageSlugMap[serviceKey].en}`;
  const canonicalUrl = `https://www.aurenspa.com${routePath}`;

  return (
    <div className="service-detail-page">
     <Helmet>
       <title>{service.title} — Auren SPA</title>
